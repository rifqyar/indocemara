<?php $__env->startSection('title', 'Home | Indo Cemara'); ?>
		    ...
		    <div class="row">
		      <div class="col-md-8 col-sm-8 col-xs-12">
		        <div class="right-caption wow animated fadeInRight">
		          <h4>Introducing IndoCemaranjay</h4>
		          <h2><span class="orange"><i><b>#1 Family DNA</b></i></span> Search in <span class="orange">Indonesia</span></h2>
		    ...
		    <div class="sevice-items">
		      <div class="col-md-4 col-sm-6 wow bounceInUp">
		        <div class="single-item">
		          ...
		          <h2>DNA Ancestry</h2>
		          <p>Test DNA to see who's your family</p>
		        </div>
		      </div>
		      <div class="col-md-4 col-sm-6 wow bounceInUp">
		        <div class="single-item">
		      ...
		      <div class="col-md-4 col-sm-6 wow bounceInUp">
		        <div class="single-item">
		          ...
		          <h2>Family Search</h2>
		          <p>Your family member is missing? search it now!.</p>
		        </div>
		      </div>
		    </div>
		  </div>
...
<?php echo $__env->make('user.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\indocemara\resources\views/user/home.blade.php ENDPATH**/ ?>